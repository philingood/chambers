...
int main(int argc, char **argv)
{
	...
	*/
	...
	if ((fout = fopen("holod-win64.rez", "wt")) == NULL)
	{
...
void read_data(void)
{
	...
	const char *toplpara[] = {/* названия топливных пар */
						/*01*/ "АК + керосин Т-1",
						/*02*/ "АК + тонка",
						/*03*/ "АК-27 + тонка",
						/*04*/ "АК-27 + НДМГ",
	...
	const char *tpls[] = {/* названия охладителей */
					/*01*/ "АК",
					/*02*/ "АК-27",
					/*03*/ "керосин Т-1",
					/*04*/ "тонка",
	...
	const char *tsech[] = {/* названия типов сечений */
					 /*0*/ "Ребра",
					 /*1*/ "Гофры",
					 /*2*/ "Трубки",
					 /*3*/ "Щель",
	...
	const char *maters[] = {/* названия материалов стенок */
					  /*0*/ "ВТ-00",
					  /*1*/ "Тi-сплав",
					  /*2*/ "12X18H10T",
					  /*3*/ "08X17H5M3",
	...
	const char *numbers[] = {/* числительные для информации
